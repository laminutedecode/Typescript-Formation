...
let mixedArray = [1, "Hello", true]; // Tableau contenant des éléments de types différents
let anyObject = { name: "Alice", age: 30 }; // Objet avec des propriétés de types différents
