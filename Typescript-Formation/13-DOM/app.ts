...
const btn = document.querySelector('.btn') as HTMLHeadingElement;
...
const stringLength: number = (<string>myVariable).length;
...
const myVariable2: any = "Hello, TypeScript!";
const length2: number = (myVariable2 as string).length;
