...
let data: [string | number, boolean] = ["Alice", true]; // Le premier élément peut être une chaîne de caractères ou un nombre
...
let person2: [string, number, boolean] = ["Alice", 30, true];
