...
let numbers: number[] = [1, 2, 3, 4, 5]; // Initialise un tableau de nombres avec des valeurs
let names: string[] = []; // Initialise un tableau vide de chaînes de caractères
names.push("Alice", "Bob", "Charlie"); // Ajoute des valeurs au tableau ultérieurement
let values: Array<number> = new Array<number>(10); // Initialise un tableau de nombres vide avec une taille spécifiée
...
let mixed: (string | number)[] = ["Alice", 1, "Bob", 2];
